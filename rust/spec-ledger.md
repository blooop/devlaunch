...
| `test/test_dl.py` | pending | flow classes re-pinned; read-side + lifecycle dispatch and refresh spawning at boundary (dl/tests); launch-verb dispatch awaits M7-wiring |
