...
mod tests {
    ...
    fn golden_specs() -> Vec<Case> {
        vec![
            ...
            Case { spec: "blooop/devlaunch@main", shape: Shape::OwnerRepo { owner: "blooop", repo: "devlaunch", branch: Some("main") }, expanded: "git@github.com:blooop/devlaunch.git@main", identity: Expect::Workspace("devlaunch-main-3j1t") },
            Case { spec: "owner/repo@feature/my-branch", shape: Shape::OwnerRepo { owner: "owner", repo: "repo", branch: Some("feature/my-branch") }, expanded: "git@github.com:owner/repo.git@feature/my-branch", identity: Expect::Workspace("repo-feature-my-branch-xe0p") },
            Case { spec: "Owner/Repo@Feature/MyBranch", shape: Shape::OwnerRepo { owner: "Owner", repo: "Repo", branch: Some("Feature/MyBranch") }, expanded: "git@github.com:Owner/Repo.git@Feature/MyBranch", identity: Expect::Workspace("repo-feature-mybranch-dluh") },
            ...
            Case { spec: "blooop/test_renv@nb12", shape: Shape::OwnerRepo { owner: "blooop", repo: "test_renv", branch: Some("nb12") }, expanded: "git@github.com:blooop/test_renv.git@nb12", identity: Expect::Workspace("test-renv-nb12-xfr4") },
            Case { spec: "blooop/test_renv@nb14", shape: Shape::OwnerRepo { owner: "blooop", repo: "test_renv", branch: Some("nb14") }, expanded: "git@github.com:blooop/test_renv.git@nb14", identity: Expect::Workspace("test-renv-nb14-fy8q") },
            ...
            Case { spec: "blooop/python_template@nb4", shape: Shape::OwnerRepo { owner: "blooop", repo: "python_template", branch: Some("nb4") }, expanded: "git@github.com:blooop/python_template.git@nb4", identity: Expect::Workspace("python-template-nb4-jqpj") },
            ...
            Case { spec: "owner/repo@main", shape: Shape::OwnerRepo { owner: "owner", repo: "repo", branch: Some("main") }, expanded: "git@github.com:owner/repo.git@main", identity: Expect::Workspace("repo-main-dkjd") },
            Case { spec: "owner/repo@Main", shape: Shape::OwnerRepo { owner: "owner", repo: "repo", branch: Some("Main") }, expanded: "git@github.com:owner/repo.git@Main", identity: Expect::Workspace("repo-main-kqz7") },
            Case { spec: "someone/devlaunch@main", shape: Shape::OwnerRepo { owner: "someone", repo: "devlaunch", branch: Some("main") }, expanded: "git@github.com:someone/devlaunch.git@main", identity: Expect::Workspace("devlaunch-main-div6") },
            Case { spec: "blooop/devlaunch@feature/auth", shape: Shape::OwnerRepo { owner: "blooop", repo: "devlaunch", branch: Some("feature/auth") }, expanded: "git@github.com:blooop/devlaunch.git@feature/auth", identity: Expect::Workspace("devlaunch-feature-auth-np10") },
            Case { spec: "blooop/devlaunch@feature-auth", shape: Shape::OwnerRepo { owner: "blooop", repo: "devlaunch", branch: Some("feature-auth") }, expanded: "git@github.com:blooop/devlaunch.git@feature-auth", identity: Expect::Workspace("devlaunch-feature-auth-lsi0") },
            ...
            Case { spec: "owner/repo@", shape: Shape::ExistingIdOrName, expanded: "owner/repo@", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "owner/repo@br@x", shape: Shape::ExistingIdOrName, expanded: "owner/repo@br@x", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "owner/repo@a b", shape: Shape::ExistingIdOrName, expanded: "owner/repo@a b", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "owner/repo@a:b", shape: Shape::SshUrl, expanded: "owner/repo@a:b", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            ...
            Case { spec: "owner/repo@feature/../x", shape: Shape::OwnerRepo { owner: "owner", repo: "repo", branch: Some("feature/../x") }, expanded: "git@github.com:owner/repo.git@feature/../x", identity: Expect::Workspace("repo-feature-x-e9ge") },
            ...
            Case { spec: "owner/repo@br\n", shape: Shape::OwnerRepo { owner: "owner", repo: "repo", branch: Some("br\n") }, expanded: "git@github.com:owner/repo.git@br\n", identity: Expect::Workspace("repo-br-f8id") },
            Case { spec: "owner/repo@br\nx", shape: Shape::ExistingIdOrName, expanded: "owner/repo@br\nx", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "github.com/owner/repo", shape: Shape::HostPath, expanded: "github.com/owner/repo", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "github.com/owner/repo.git", shape: Shape::HostPath, expanded: "github.com/owner/repo.git", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "github.com/owner/repo@branch", shape: Shape::HostPath, expanded: "github.com/owner/repo@branch", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "gitlab.com/owner/repo", shape: Shape::HostPath, expanded: "gitlab.com/owner/repo", identity: Expect::Workspace("gitlab-com-owner-repo-y16y") },
            Case { spec: "gitlab.com/group/my_repo", shape: Shape::HostPath, expanded: "gitlab.com/group/my_repo", identity: Expect::Workspace("gitlab-com-group-my-repo-c8uq") },
            Case { spec: "gitlab.com/group/my-repo", shape: Shape::HostPath, expanded: "gitlab.com/group/my-repo", identity: Expect::Workspace("gitlab-com-group-my-repo-1n65") },
            Case { spec: "gitlab.com/group/my.repo", shape: Shape::HostPath, expanded: "gitlab.com/group/my.repo", identity: Expect::Workspace("gitlab-com-group-my-repo-wl1k") },
            Case { spec: "github.com/owner", shape: Shape::HostPath, expanded: "github.com/owner", identity: Expect::Workspace("github-com-owner-k2lz") },
            Case { spec: "github.com/loft-sh/devpod", shape: Shape::HostPath, expanded: "github.com/loft-sh/devpod", identity: Expect::Workspace("github-com-loft-sh-devpod-oowa") },
            Case { spec: "github.com/Blooop/DevLaunch", shape: Shape::HostPath, expanded: "github.com/Blooop/DevLaunch", identity: Expect::Workspace("github-com-blooop-devlaunch-swgi") },
            Case { spec: "github.com/blooop/devlaunch", shape: Shape::HostPath, expanded: "github.com/blooop/devlaunch", identity: Expect::Workspace("github-com-blooop-devlaunch-swgi") },
            Case { spec: "github.com/oooooooooooooooooooooooooooooooooooooooo/rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr", shape: Shape::HostPath, expanded: "github.com/oooooooooooooooooooooooooooooooooooooooo/rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr", identity: Expect::Workspace("github-com-ooooooooooooooooooooooooooooooo-8hgl") },
            Case { spec: "https://github.com/owner/repo", shape: Shape::Url, expanded: "https://github.com/owner/repo", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "https://github.com/owner/repo@main", shape: Shape::Url, expanded: "https://github.com/owner/repo@main", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "https://github.com/owner/repo.git", shape: Shape::Url, expanded: "https://github.com/owner/repo.git", identity: Expect::Workspace("github-com-owner-repo-jbsm") },
            Case { spec: "https://user@host/x", shape: Shape::Url, expanded: "https://user@host/x", identity: Expect::Workspace("user-cp0n") },
            Case { spec: "ssh://git@github.com/o/r.git", shape: Shape::Url, expanded: "ssh://git@github.com/o/r.git", identity: Expect::Workspace("git-55pr") },
            ...
            Case { spec: "a/b@c:d", shape: Shape::SshUrl, expanded: "a/b@c:d", identity: Expect::Workspace("github-com-a-b-w4x1") },
        ]
    }
    ...
    fn owner_repo_with_a_branch_derives_the_triples_id() {
        assert_eq!(
            ...
            Expect::Workspace("devlaunch-main-3j1t")
        );
    }
