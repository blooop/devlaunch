...
'prune' was a second spelling of the rm verb and is retired: it collided with
--prune above, which removes clone directories and no workspace at all. Typing it
